...
#aliases
 ...
 alias download='wget'
 alias sketchystart='brew services start sketchybar'
 alias sketchystop='brew services stop sketchybar'
 alias resetRectangle="pkill -x 'Rectangle' && open -a Rectangle "
#alias End
...
#function 
  function charge() {system_profiler SPPowerDataType | awk 'BEGIN{RS="Events"; FS="AC"}NF>1{print $NF}'}
